...
/**
 * Class CmsPluginFunctionsipBoard
 */
class CmsPluginFunctionsipBoard
{
    ...
    private $jsConfig = '{
        ...
        "youtube"         : "https://www.youtube.com/watch?v=VGeRTfB4e_Y",
        "feedback"        : "https://cms2cms.survey.fm/survey",
        "support"         : "https://app.cms2cms.com?chat=fullscreen",
        "wizard"          : "https://app.cms2cms.com/wizard",
        "facebook"        : "https://www.facebook.com/CMS2CMS/",
        "twitter"         : "https://twitter.com/Cms2Cms",
        "wp_feedback"     : "//wordpress.org/support/plugin/cms2cms-ip-board-to-bbpress-migrator/reviews",
        "public_host"     : "https://cms2cms.com/",
        "bridge"          : "https://app.cms2cms.com/bridge/download",
        "ipBoardExtension": "https://downloads.wordpress.org/plugin/cms2cms-ip-board-to-bbpress-migrator.3.7.0.zip",
    ...
    {
        $cms2cms_ipBoard_access_login = get_option('cms2cms-ipBoard-login');
        $cms2cms_ipBoard_access_key   = get_option('cms2cms-ipBoard-key');

        return array(
            'email'     => $cms2cms_ipBoard_access_login,
            'accessKey' => $cms2cms_ipBoard_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_ipBoard_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-ipBoard-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-ipBoard-key', $key);

            delete_option('cms2cms-ipBoard-login');
            add_option('cms2cms-ipBoard-login', $login);

            delete_option('cms2cms-ipBoard-depth');
            add_option('cms2cms-ipBoard-depth', $bridge_depth);
    ...
    {
        return $this->__('IP.Board', 'cms2cms-ipBoard-migration');
    }
    ...
    {
        return $this->__('bbPress', 'cms2cms-ipBoard-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-ipBoard-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-ipBoard-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
    ...
    public function getExtensionUrl()
    {
        ...
        return $config['ipBoardExtension'];
    }
    ...
    public function logOut()
    {
        if (isset($_REQUEST['_wpnonce'])) {
            ...
            if ($this->verifyFormTempKey($nonce, 'cms2cms_ipBoard_logout')
                && $_POST['cms2cms_ipBoard_logout'] == 1
            ) {
                $this->clearOptions();
            }
        }
